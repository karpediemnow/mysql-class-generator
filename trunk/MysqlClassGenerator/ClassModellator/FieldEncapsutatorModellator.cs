...
namespace ClassModellator
{
    ...
    /// </code>
    /// </summary>
    public class FieldEncapsutatorModellator : FieldModelletor, ClassModellator.Interface.IPropertyModellator
    {
        ...
        /// default contructor
        /// </summary>
        public FieldEncapsutatorModellator()
        {
        ...
        public FieldEncapsutatorModellator(String Name, String Type)
            : base(Type, Name)
        {
            this.Name = Name;
            this.Type = Type;
        ...
        public FieldEncapsutatorModellator(String Name, String Type, bool createGET, bool createSET)
            : this(Name,Type)
        {
        ...
        public FieldEncapsutatorModellator(String Name, String Type, bool createGET, bool createSET,String Description)
            : this( Name, Type, createGET, createSET)
        {
            base.Description = Description;
        }

        public FieldEncapsutatorModellator(String Name, String Type, bool createGET, bool createSET, String Summary, Modifier AccessModifier)
        ...
        public FieldEncapsutatorModellator(String Name, String Type, bool createGET, bool createSET, String Summary, Modifier AccessModifier ,Modifier Modifier)
            : this(Name, Type, createGET, createSET, Summary)
        {
            base.AccessModifier = AccessModifier;
        ...
        {
            StringBuilder sb = new StringBuilder();
            sb.Append(this.getEncapsulationFied());
            sb.Append(Environment.NewLine);
            return sb.ToString();
        }
