...
namespace ClassModellator.MysqlClassModellator.MysqlClassModellator
{
    ...
    { 
        ...
        createTableModellator _createTableModellator;

        public createTableModellator CreateTableModellator
        {
            get { return _createTableModellator; }
            set { _createTableModellator = value; }
        }
        ...
        public override String getClassModellated()
        {
            ...
            if (this.Name != null)
            {
                try
                {
                    ...
                    outputString.Append(Environment.NewLine);
                    outputString.Append(this._createTableModellator.getFunctionModelleted());
                    outputString.Append(Environment.NewLine);
                    outputString.Append("\t\t#endregion" + Environment.NewLine + Environment.NewLine);
